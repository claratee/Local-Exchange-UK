...
class cDirectory {
	...
	function DownloadDirectory () {	
		...
		$this->PrintSectionHeader("Member Information",FIRST);
		$this->PrintMembers();
	
		$this->PrintSectionHeader("Offered Listings");
		$this->PrintListings(OFFER_LISTING);
		
		$this->PrintSectionHeader("Wanted Listings");
	...
	function PrintFirstPage() {
		...
		$this->pdf->Write(8,"Members Directory\n");
		$this->pdf->setFont($this->font,"",$this->font_size);
	}
