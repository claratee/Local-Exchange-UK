...
$p->page_title = "Edit Listing Category";
...
// Define form rules
//
$form->addRule('category', 'Category description cannot be blank', 'required');
...
function process_data ($values) {
	...
	if ($category->SaveCategory()) {
		$output = "The category has been updated.";
	} else {
		$output = "Could not save changes to the category.  Please try again later.";
	}
